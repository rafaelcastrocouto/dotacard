...
(function ($, window) {
  ...
  var tubular = function(node, options) { // should be called on the wrapper div
    ...
    if(options.onBeforeLoad){options.onBeforeLoad(tubularContainer)};
    ...
    var onPlayerReady = function(e) {
      ...
      e.target.playVideo();
      if(options.onReady) options.onReady($(e.target.d).closest('.tubular-container'));
    };
    ...
    var onPlayerStateChange = function(e) {
      ...
      if(options.onStateChange) options.onStateChange($(e.target.d).closest('.tubular-container'));
    };
