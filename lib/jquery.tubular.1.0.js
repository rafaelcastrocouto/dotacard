...
;(function ($, window) {
    ...
    var tubular = function(node, options) { // should be called on the wrapper div
        ...
        // build container
        var tubularContainer = '<div id="tubular-container" class="tubular" style="overflow: hidden; width: 100%; height: 100%"><div id="tubular-player" class="tubular" style="position: absolute"></div></div><div id="tubular-shield"  class="tubular" style="width: 100%; height: 100%; position: absolute; left: 0; top: 0;"></div>';
