game.states.log = {
  ...
  build: function () {
    ...
    this.input = $('<input>').appendTo(this.form).attr({placeholder: game.data.ui.logtype, type: 'text', required: 'required', minlength: 3, maxlength: 24}).keydown(function (event) { if (event.which === 13) { game.states.log.login(); } });
